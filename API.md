...
- **Swagger UI**: `/docs`, доступен только при `NODE_ENV=development` (в остальных окружениях — `404`, т.к. страница не может отправить заголовок `X-Internal-API-Secret` при обычной навигации браузера).
